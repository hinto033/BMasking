...
# Load the 1000 Sequentials *~*~*~*~*~**~*~*~**~*~*~*~*~*~*~*~*~*~*~*~*~*~*#####

# wdSeq <- "D:\\LabData\\BreastMasking\\7.20.17_CompiledData_Simulated_UCSFSequential\\"
wdSeq <- "W:\\Breast Studies\\Masking\\BJH_MaskingMaps\\7.20.17_CompiledData_Simulated_UCSFSequential\\"

setwd(wdSeq)
fileNames <- list.files(wdSeq)
nRows <- length(fileNames)
seqData <- data.frame(num=1:nRows)
for (i in 1:nRows){
  imageStats <- readMat(fileNames[i])
  
  seqData$fileName[i] <- fileNames[i]
  seqData$tmp[i] <- strsplit(fileNames[i], '_')[[1]][2]
  seqData$acquisition_id[i] <- strsplit(seqData$tmp[i], '[.]')[[1]][1]
  seqData$view[i] <- imageStats$stats[,,1]$DICOMData[,,1]$Position[1,1]
  seqData$Interval <- NA
  seqData$ScreenDetected <- NA
  seqData$largeMean[i] <- imageStats$stats[,,1]$Large[,,1]$Mean[1,1]
  seqData$largeMedian[i] <- imageStats$stats[,,1]$Large[,,1]$Median[1,1]
  seqData$largeStDev[i] <- imageStats$stats[,,1]$Large[,,1]$StDev[1,1]
  seqData$largeSum[i] <- imageStats$stats[,,1]$Large[,,1]$Sum[1,1]
  seqData$largeEntropy[i] <- imageStats$stats[,,1]$Large[,,1]$Entropy[1,1]
  seqData$largeKurtosis[i] <- imageStats$stats[,,1]$Large[,,1]$Kurtosis[1,1]
  seqData$largeSkewness[i] <- imageStats$stats[,,1]$Large[,,1]$Skewness[1,1]
  seqData$largePctile10[i] <- imageStats$stats[,,1]$Large[,,1]$Pctile10[1,1]
  seqData$largePctile25[i] <- imageStats$stats[,,1]$Large[,,1]$Pctile25[1,1]
  seqData$largePctile75[i] <- imageStats$stats[,,1]$Large[,,1]$Pctile75[1,1]
  seqData$largePctile90[i] <- imageStats$stats[,,1]$Large[,,1]$Pctile90[1,1]
  seqData$largePctBelowPnt5[i] <- imageStats$stats[,,1]$Large[,,1]$pctBelowPnt5[1,1]
  seqData$largePctBelow1[i] <- imageStats$stats[,,1]$Large[,,1]$pctBelow1[1,1]
  seqData$largePctBelow1Pnt25[i] <- imageStats$stats[,,1]$Large[,,1]$pctBelow1Pnt25[1,1]
  seqData$largePctBelow1Pnt5[i] <- imageStats$stats[,,1]$Large[,,1]$pctBelow1Pnt5[1,1]
  seqData$largePctBelow2[i] <- imageStats$stats[,,1]$Large[,,1]$pctBelow2[1,1]
  seqData$largePctBelow3[i] <- imageStats$stats[,,1]$Large[,,1]$pctBelow3[1,1]
  seqData$largePctBelow4[i] <- imageStats$stats[,,1]$Large[,,1]$pctBelow4[1,1]
  seqData$largePctBelow5[i] <- imageStats$stats[,,1]$Large[,,1]$pctBelow5[1,1]
  seqData$largePctBelow7[i] <- imageStats$stats[,,1]$Large[,,1]$pctBelow7[1,1]
  seqData$largePctBelow10[i] <- imageStats$stats[,,1]$Large[,,1]$pctBelow10[1,1]
  seqData$largePctBelow12[i] <- imageStats$stats[,,1]$Large[,,1]$pctBelow12[1,1]
  seqData$largePctBelow14[i] <- imageStats$stats[,,1]$Large[,,1]$pctBelow14[1,1]
  seqData$largePctBelow16[i] <- imageStats$stats[,,1]$Large[,,1]$pctBelow16[1,1]
  seqData$largePctBelow18[i] <- imageStats$stats[,,1]$Large[,,1]$pctBelow18[1,1]
  seqData$largePctBelow20[i] <- imageStats$stats[,,1]$Large[,,1]$pctBelow20[1,1]
  seqData$largeGLCMContrast[i] <- imageStats$stats[,,1]$Large[,,1]$GLCMContrast[1,1]
  seqData$largeGLCMCorr[i] <- imageStats$stats[,,1]$Large[,,1]$GLCMCorr[1,1]
  seqData$largeGLCMEnergy[i] <- imageStats$stats[,,1]$Large[,,1]$GLCMEnergy[1,1]
  seqData$largeGLCMHomog[i] <- imageStats$stats[,,1]$Large[,,1]$GLCMHomog[1,1]
  
  seqData$mediumMean[i] <- imageStats$stats[,,1]$Medium[,,1]$Mean[1,1]
  seqData$mediumMedian[i] <- imageStats$stats[,,1]$Medium[,,1]$Median[1,1]
  seqData$mediumStDev[i] <- imageStats$stats[,,1]$Medium[,,1]$StDev[1,1]
  seqData$mediumSum[i] <- imageStats$stats[,,1]$Medium[,,1]$Sum[1,1]
  seqData$mediumEntropy[i] <- imageStats$stats[,,1]$Medium[,,1]$Entropy[1,1]
  seqData$mediumKurtosis[i] <- imageStats$stats[,,1]$Medium[,,1]$Kurtosis[1,1]
  seqData$mediumSkewness[i] <- imageStats$stats[,,1]$Medium[,,1]$Skewness[1,1]
  seqData$mediumPctile10[i] <- imageStats$stats[,,1]$Medium[,,1]$Pctile10[1,1]
  seqData$mediumPctile25[i] <- imageStats$stats[,,1]$Medium[,,1]$Pctile25[1,1]
  seqData$mediumPctile75[i] <- imageStats$stats[,,1]$Medium[,,1]$Pctile75[1,1]
  seqData$mediumPctile90[i] <- imageStats$stats[,,1]$Medium[,,1]$Pctile90[1,1]
  seqData$mediumPctBelowPnt5[i] <- imageStats$stats[,,1]$Medium[,,1]$pctBelowPnt5[1,1]
  seqData$mediumPctBelow1[i] <- imageStats$stats[,,1]$Medium[,,1]$pctBelow1[1,1]
  seqData$mediumPctBelow1Pnt25[i] <- imageStats$stats[,,1]$Medium[,,1]$pctBelow1Pnt25[1,1]
  seqData$mediumPctBelow1Pnt5[i] <- imageStats$stats[,,1]$Medium[,,1]$pctBelow1Pnt5[1,1]
  seqData$mediumPctBelow2[i] <- imageStats$stats[,,1]$Medium[,,1]$pctBelow2[1,1]
  seqData$mediumPctBelow3[i] <- imageStats$stats[,,1]$Medium[,,1]$pctBelow3[1,1]
  seqData$mediumPctBelow4[i] <- imageStats$stats[,,1]$Medium[,,1]$pctBelow4[1,1]
  seqData$mediumPctBelow5[i] <- imageStats$stats[,,1]$Medium[,,1]$pctBelow5[1,1]
  seqData$mediumPctBelow7[i] <- imageStats$stats[,,1]$Medium[,,1]$pctBelow7[1,1]
  seqData$mediumPctBelow10[i] <- imageStats$stats[,,1]$Medium[,,1]$pctBelow10[1,1]
  seqData$mediumPctBelow12[i] <- imageStats$stats[,,1]$Medium[,,1]$pctBelow12[1,1]
  seqData$mediumPctBelow14[i] <- imageStats$stats[,,1]$Medium[,,1]$pctBelow14[1,1]
  seqData$mediumPctBelow16[i] <- imageStats$stats[,,1]$Medium[,,1]$pctBelow16[1,1]
  seqData$mediumPctBelow18[i] <- imageStats$stats[,,1]$Medium[,,1]$pctBelow18[1,1]
  seqData$mediumPctBelow20[i] <- imageStats$stats[,,1]$Medium[,,1]$pctBelow20[1,1]
  seqData$mediumGLCMContrast[i] <- imageStats$stats[,,1]$Medium[,,1]$GLCMContrast[1,1]
  seqData$mediumGLCMCorr[i] <- imageStats$stats[,,1]$Medium[,,1]$GLCMCorr[1,1]
  seqData$mediumGLCMEnergy[i] <- imageStats$stats[,,1]$Medium[,,1]$GLCMEnergy[1,1]
  seqData$mediumGLCMHomog[i] <- imageStats$stats[,,1]$Medium[,,1]$GLCMHomog[1,1]
  
  seqData$smallMean[i] <- imageStats$stats[,,1]$Small[,,1]$Mean[1,1]
  seqData$smallMedian[i] <- imageStats$stats[,,1]$Small[,,1]$Median[1,1]
  seqData$smallStDev[i] <- imageStats$stats[,,1]$Small[,,1]$StDev[1,1]
  seqData$smallSum[i] <- imageStats$stats[,,1]$Small[,,1]$Sum[1,1]
  seqData$smallEntropy[i] <- imageStats$stats[,,1]$Small[,,1]$Entropy[1,1]
  seqData$smallKurtosis[i] <- imageStats$stats[,,1]$Small[,,1]$Kurtosis[1,1]
  seqData$smallSkewness[i] <- imageStats$stats[,,1]$Small[,,1]$Skewness[1,1]
  seqData$smallPctile10[i] <- imageStats$stats[,,1]$Small[,,1]$Pctile10[1,1]
  seqData$smallPctile25[i] <- imageStats$stats[,,1]$Small[,,1]$Pctile25[1,1]
  seqData$smallPctile75[i] <- imageStats$stats[,,1]$Small[,,1]$Pctile75[1,1]
  seqData$smallPctile90[i] <- imageStats$stats[,,1]$Small[,,1]$Pctile90[1,1]
  seqData$smallPctBelowPnt5[i] <- imageStats$stats[,,1]$Small[,,1]$pctBelowPnt5[1,1]
  seqData$smallPctBelow1[i] <- imageStats$stats[,,1]$Small[,,1]$pctBelow1[1,1]
  seqData$smallPctBelow1Pnt25[i] <- imageStats$stats[,,1]$Small[,,1]$pctBelow1Pnt25[1,1]
  seqData$smallPctBelow1Pnt5[i] <- imageStats$stats[,,1]$Small[,,1]$pctBelow1Pnt5[1,1]
  seqData$smallPctBelow2[i] <- imageStats$stats[,,1]$Small[,,1]$pctBelow2[1,1]
  seqData$smallPctBelow3[i] <- imageStats$stats[,,1]$Small[,,1]$pctBelow3[1,1]
  seqData$smallPctBelow4[i] <- imageStats$stats[,,1]$Small[,,1]$pctBelow4[1,1]
  seqData$smallPctBelow5[i] <- imageStats$stats[,,1]$Small[,,1]$pctBelow5[1,1]
  seqData$smallPctBelow7[i] <- imageStats$stats[,,1]$Small[,,1]$pctBelow7[1,1]
  seqData$smallPctBelow10[i] <- imageStats$stats[,,1]$Small[,,1]$pctBelow10[1,1]
  seqData$smallPctBelow12[i] <- imageStats$stats[,,1]$Small[,,1]$pctBelow12[1,1]
  seqData$smallPctBelow14[i] <- imageStats$stats[,,1]$Small[,,1]$pctBelow14[1,1]
  seqData$smallPctBelow16[i] <- imageStats$stats[,,1]$Small[,,1]$pctBelow16[1,1]
  seqData$smallPctBelow18[i] <- imageStats$stats[,,1]$Small[,,1]$pctBelow18[1,1]
  seqData$smallPctBelow20[i] <- imageStats$stats[,,1]$Small[,,1]$pctBelow20[1,1]
  seqData$smallGLCMContrast[i] <- imageStats$stats[,,1]$Small[,,1]$GLCMContrast[1,1]
  seqData$smallGLCMCorr[i] <- imageStats$stats[,,1]$Small[,,1]$GLCMCorr[1,1]
  seqData$smallGLCMEnergy[i] <- imageStats$stats[,,1]$Small[,,1]$GLCMEnergy[1,1]
  seqData$smallGLCMHomog[i] <- imageStats$stats[,,1]$Small[,,1]$GLCMHomog[1,1]
  
  # 
  seqData$fullMean[i] <- imageStats$stats[,,1]$Full[,,1]$Mean[1,1]
  seqData$fullMedian[i] <- imageStats$stats[,,1]$Full[,,1]$Median[1,1]
  seqData$fullStDev[i] <- imageStats$stats[,,1]$Full[,,1]$StDev[1,1]
  seqData$fullSum[i] <- imageStats$stats[,,1]$Full[,,1]$Sum[1,1]
  seqData$fullEntropy[i] <- imageStats$stats[,,1]$Full[,,1]$Entropy[1,1]
  seqData$fullKurtosis[i] <- imageStats$stats[,,1]$Full[,,1]$Kurtosis[1,1]
  seqData$fullSkewness[i] <- imageStats$stats[,,1]$Full[,,1]$Skewness[1,1]
  seqData$fullPctile10[i] <- imageStats$stats[,,1]$Full[,,1]$Pctile10[1,1]
  seqData$fullPctile25[i] <- imageStats$stats[,,1]$Full[,,1]$Pctile25[1,1]
  seqData$fullPctile75[i] <- imageStats$stats[,,1]$Full[,,1]$Pctile75[1,1]
  seqData$fullPctile90[i] <- imageStats$stats[,,1]$Full[,,1]$Pctile90[1,1]
  seqData$fullPctBelowPnt5[i] <- imageStats$stats[,,1]$Full[,,1]$pctBelowPnt5[1,1]
  seqData$fullPctBelow1[i] <- imageStats$stats[,,1]$Full[,,1]$pctBelow1[1,1]
  seqData$fullPctBelow1Pnt25[i] <- imageStats$stats[,,1]$Full[,,1]$pctBelow1Pnt25[1,1]
  seqData$fullPctBelow1Pnt5[i] <- imageStats$stats[,,1]$Full[,,1]$pctBelow1Pnt5[1,1]
  seqData$fullPctBelow2[i] <- imageStats$stats[,,1]$Full[,,1]$pctBelow2[1,1]
  seqData$fullPctBelow3[i] <- imageStats$stats[,,1]$Full[,,1]$pctBelow3[1,1]
  seqData$fullPctBelow4[i] <- imageStats$stats[,,1]$Full[,,1]$pctBelow4[1,1]
  seqData$fullPctBelow5[i] <- imageStats$stats[,,1]$Full[,,1]$pctBelow5[1,1]
  seqData$fullPctBelow7[i] <- imageStats$stats[,,1]$Full[,,1]$pctBelow7[1,1]
  seqData$fullPctBelow10[i] <- imageStats$stats[,,1]$Full[,,1]$pctBelow10[1,1]
  seqData$fullPctBelow12[i] <- imageStats$stats[,,1]$Full[,,1]$pctBelow12[1,1]
  seqData$fullPctBelow14[i] <- imageStats$stats[,,1]$Full[,,1]$pctBelow14[1,1]
  seqData$fullPctBelow16[i] <- imageStats$stats[,,1]$Full[,,1]$pctBelow16[1,1]
  seqData$fullPctBelow18[i] <- imageStats$stats[,,1]$Full[,,1]$pctBelow18[1,1]
  seqData$fullPctBelow20[i] <- imageStats$stats[,,1]$Full[,,1]$pctBelow20[1,1]
  seqData$fullGLCMContrast[i] <- imageStats$stats[,,1]$Full[,,1]$GLCMContrast[1,1]
  seqData$fullGLCMCorr[i] <- imageStats$stats[,,1]$Full[,,1]$GLCMCorr[1,1]
  seqData$fullGLCMEnergy[i] <- imageStats$stats[,,1]$Full[,,1]$GLCMEnergy[1,1]
  seqData$fullGLCMHomog[i] <- imageStats$stats[,,1]$Full[,,1]$GLCMHomog[1,1]
  # 
  # 
  seqData$imgBMean[i] <- imageStats$stats[,,1]$imgB[,,1]$Mean[1,1]
  seqData$imgBMedian[i] <- imageStats$stats[,,1]$imgB[,,1]$Median[1,1]
  seqData$imgBSum[i] <- imageStats$stats[,,1]$imgB[,,1]$Sum[1,1]
  seqData$imgBPctile10[i] <- imageStats$stats[,,1]$imgB[,,1]$Pctile10[1,1]
  seqData$imgBPctile25[i] <- imageStats$stats[,,1]$imgB[,,1]$Pctile25[1,1]
  seqData$imgBPctile75[i] <- imageStats$stats[,,1]$imgB[,,1]$Pctile75[1,1]
  seqData$imgBPctile90[i] <- imageStats$stats[,,1]$imgB[,,1]$Pctile90[1,1]
  seqData$imgAMean[i] <- imageStats$stats[,,1]$imgA[,,1]$Mean[1,1]
  seqData$imgAMedian[i] <- imageStats$stats[,,1]$imgA[,,1]$Median[1,1]
  seqData$imgASum[i] <- imageStats$stats[,,1]$imgA[,,1]$Sum[1,1]
  seqData$imgAPctile10[i] <- imageStats$stats[,,1]$imgA[,,1]$Pctile10[1,1]
  seqData$imgAPctile25[i] <- imageStats$stats[,,1]$imgA[,,1]$Pctile25[1,1]
  seqData$imgAPctile75[i] <- imageStats$stats[,,1]$imgA[,,1]$Pctile75[1,1]
  seqData$imgAPctile90[i] <- imageStats$stats[,,1]$imgA[,,1]$Pctile90[1,1]
}
...
# LASSO EXAMPLE (CC & MLO & AUC PLOTS) *~*~*~*~*~**~*~*~**~*~*~*~*~*~*~*~*~*~*~*~*~*~*##### 
...
#CC Data
for (i in 8:nCols){
  keepVar<- c(keepNoVar, colnames(DataCC[i]))
  
  modelDataCC <- DataCC[keepVar]
  
  
  inputx <-  as.matrix(modelDataCC[,2:ncol(modelDataCC)])
  maxxs <- apply(inputx, 2, max)
  inputx <- t(t(inputx) / maxxs)
  outputy <- as.matrix(modelDataCC[,1])
  outputy <- outputy / max(outputy)
  
  #Need to see if I alter this for logistic regression *~*~*~*~*~**~*~*~**~*~*~*~*~*~*~*~*~*~*~*~*~*~*
  cvfit <- cv.glmnet(inputx,outputy)
  print(coef(cvfit, s = "lambda.1se"))
  print(cor(inputx, outputy))
  
  
  cvpred <- predict.cv.glmnet(cvfit, inputx, s=c("lambda.1se", "lambda.min") )
  ttt<- cbind(outputy, cvpred)
  plot(outputy, cvpred)
  title(paste("BloodMarker = ", bMarker, sep=""))
  
  #Need to see how to save relevant data  here *~*~*~*~*~**~*~*~**~*~*~*~*~*~*~*~*~*~*~*~*~*~*
  
  #Need to see how to plot AUC here *~*~*~*~*~**~*~*~**~*~*~*~*~*~*~*~*~*~*~*~*~*~*
...
for (i in 8:nCols){
  ...
  modelDataMLO <- DataCC[keepVar]
  
  inputx <-  as.matrix(modelDataMLO[,2:ncol(modelDataMLO)])
  maxxs <- apply(inputx, 2, max)
  inputx <- t(t(inputx) / maxxs)
  outputy <- as.matrix(modelDataMLO[,1])
  outputy <- outputy / max(outputy)
...
# Perform LASSO
inputx <-  as.matrix(predData[,2:ncol(predData)])
maxxs <- apply(inputx, 2, max)
inputx <- t(t(inputx) / maxxs)
outputy <- as.matrix(predData[,1])
outputy <- outputy / max(outputy)
...
# cvfit <- cv.glmnet(x,y)
# cvpred <- predict.cv.glmnet(cvfit, x, s=c("lambda.1se", "lambda.min") )
# ttt<- cbind(y, cvpred)
# plot(y, cvpred)

# print(coef(cvfit, s = "lambda.1se"))
# 
# plot(cvfit, xvar="norm", label=FALSE)
# plot(cvfit, xvar="dev", label=FALSE)
# plot(cvfit, xvar="lambda", label=FALSE)

keep <- c('WB_VFAT_AREA','PC1', 'PC2', 'PC3', 'PC4', 'PC5', 'PC6','PC7','PC8', 'PC9' )
...
nCCVars <- nrow(bestEntriesAUCCC)

nMLOVars <- nrow(bestEntriesAUCCC)
...
# Apply LASSO Model to 1000 sequentials *~*~*~*~*~**~*~*~**~*~*~*~*~*~*~*~*~*~*~*~*~*~*#####