...
savePaths = {'W:\Breast Studies\Masking\BJH_MaskingMaps\7.31.17_CompiledMaps_Simulated_DiscShape\'};
...
% startNum = [992, 1]
nCorrectDiscTimes=0;
for j = 1418:NumImageAnalyze %Does calculation for each image that was selected     
