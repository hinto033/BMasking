...
for (i in 8:nCols){
  ...
  # Need average the Models here
  
  
  
  # Apply Regression Model to 1000 Sequentials *~*~*~*~*~**~*~*~**~*~*~*~*~*~*~*~*~*~*~*~*~*~*#####
...
#Need to save the model for each relevant variable being predicted


# Generate plots/tables of masking amount. in 1000Seqs *~*~*~*~*~**~*~*~**~*~*~*~*~*~*~*~*~*~*~*~*~*~*#####
